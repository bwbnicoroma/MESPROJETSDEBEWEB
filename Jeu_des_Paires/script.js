...
function majAffichage(noCarte){
	switch(etatsCartes[noCarte]){
		case 0:
			imgCartes[noCarte].src="img/Card.jpg";
			break;
		case 1:
			imgCartes[noCarte].src="img/Card"+motifsCartes[noCarte]+".jpg";
			break;
		case -1:
...
function rejouer(){
	finpartie = document.getElementById("boitemodale");
    finpartie.style.visibility = "visible";
...
function compteur(){
   i = i + 1;
   document.getElementById('cpteur').innerHTML = "";  
   document.getElementById('cpteur').innerHTML += i;  
}

// On affiche la table et on rappelle le timer.

function afficherTable() {
	tapisTable = document.getElementById("tapis");
	tapisTable.style.visibility = "visible";
	timer = setInterval('compteur()', 1000);
	demarre = document.getElementById("demarrage");
